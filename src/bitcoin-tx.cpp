...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s egypt-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  egypt-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded egypt transaction") + "\n" +
              "  egypt-tx [options] -create [commands]   " + _("Create hex-encoded egypt transaction") + "\n" +
              "\n";
