...
const char * const BITCOIN_CONF_FILENAME = "egypt.conf";
const char * const BITCOIN_PID_FILENAME = "egypt.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Egypt";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Egypt";
#else
    // Unix
    return pathRet / ".egypt";
#endif
#endif
}
