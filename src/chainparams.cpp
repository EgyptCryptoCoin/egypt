...
{
    const char* pszTimestamp = "Egypt EGY started 05/10/2022 in Mexico, Farid&Cecilia A. F. G. 1970/75";
...
*/
        ...
        genesis = CreateGenesisBlock(1664943333, 2000835011, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x82098278001487d137d8f8226bc6d3da4566f1066fc3b92e441727b6a0f3bc4e"));
        assert(genesis.hashMerkleRoot == uint256S("0x7bafe82848318188077b8380146e2f7000a0ce0fc9280c843c3fa99a04f03df1"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("143.198.134.241", "143.198.134.241", true));
...
*/
        ...
        checkpointData = (CCheckpointData) {
            ...
            (     0, uint256S("0x82098278001487d137d8f8226bc6d3da4566f1066fc3b92e441727b6a0f3bc4e"))
/*          (  1000, uint256S("0x1d22823f27984810e0f77363e845556ba4a4b05cfa99e3779bd3a34fa54adfdd"))
            (  2000, uint256S("0x0d75a02c74e1eb14289beee2386016a46834b999f2ec88603410f8e10f4dd5c0"))
            ...
            ( 10000, uint256S("0xc9ea3664d91983d02144fb15cd06628443569611ab8c4ad9f74a9e7895f704b3"))
...
*/      };
        ...
        chainTxData = ChainTxData{
            ...
            1664943333, // * UNIX timestamp of last known number of transactions
...
*/
        ...
        genesis = CreateGenesisBlock(1664943333, 4787259, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xf9d7c6a7a660cf3be388edd0332c94036a679a175606f30302d6993138586cbf"));
        assert(genesis.hashMerkleRoot == uint256S("0x7bafe82848318188077b8380146e2f7000a0ce0fc9280c843c3fa99a04f03df1"));
...
*/
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0xf9d7c6a7a660cf3be388edd0332c94036a679a175606f30302d6993138586cbf")),
        };
...
*/
        ...
        genesis = CreateGenesisBlock(1664943333, 0, 0x207fffff, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0a98c99550fc41085bc25d99da9bbe5f0bd459c1fc6e5aeea5b1c160995766b3"));
        assert(genesis.hashMerkleRoot == uint256S("0x7bafe82848318188077b8380146e2f7000a0ce0fc9280c843c3fa99a04f03df1"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x0a98c99550fc41085bc25d99da9bbe5f0bd459c1fc6e5aeea5b1c160995766b3"))
        };
